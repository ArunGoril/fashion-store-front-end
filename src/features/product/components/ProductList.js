...
export default function ProductList() {
  ...
  useEffect(() => {
    setPage(1); // setting page to 1 if filter applied
  }, [totalItems, sort]);
        ...
        <div className="mt-6 grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:gap-x-8">
          {products.map((product) => (
            <Link
              ...
              key={product._id}
            >
              <div className="group relative p-1 bg-slate-100 hover:-translate-y-1 hover:scale-105">
                ...
                <div className="mt-4 flex justify-between">
                  <div>
                    ...
                    <p className="text-xs py-1 font-small text-gray-400">
                      {product.description.slice(0, 20) + "..."}
                    </p>
                    <h3 className="text-xl py-3 font-medium text-gray-500">
                      $ {product.price}
                    </h3>
                  </div>
                </div>
